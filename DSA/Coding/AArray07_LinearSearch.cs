    ...
    class AArray07
    {
        public class ArraySearch
        {
            public static void Main07()
            {
                ...
                Console.WriteLine("Does the array contain the element 4? - " + ArraySearch.linearSearch(array, length, 4));
                Console.WriteLine("Does the array contain the element 30? - " + ArraySearch.linearSearch(array, length, 30));
